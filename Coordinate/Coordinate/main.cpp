...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 创建一个模型矩阵
        glm::mat4 view = glm::mat4(1.0f); // 创建一个观察矩阵，模拟摄像机
        glm::mat4 projection = glm::mat4(1.0f); //定义一个投影矩阵
        view  = glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f)); // 将矩阵向我们要进行移动场景的反方向移动
